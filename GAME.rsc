...
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment=\
...
add action=add-dst-to-address-list address-list=youtube.com \
    address-list-timeout=01:00:00 chain=prerouting comment=YOUTUBE.COM content=\
    googlevideo.com dst-address-list="!LOKAL C"
add action=add-dst-to-address-list address-list=sosmed address-list-timeout=\
    01:00:00 chain=prerouting comment=INSTAGRAM content=.cdninstagram.com \
    dst-address-list="!LOKAL C"
add action=add-dst-to-address-list address-list=sosmed address-list-timeout=\
    01:00:00 chain=prerouting comment=INSTAGRAM content=\
    scontent-sin6-2.cdninstagram.com dst-address-list="!LOKAL C"
add action=add-dst-to-address-list address-list=sosmed address-list-timeout=\
    01:00:00 chain=prerouting comment=INSTAGRAM content=.instagram.com \
    dst-address-list="!LOKAL C"
add action=add-dst-to-address-list address-list=sosmed address-list-timeout=\
    01:00:00 chain=prerouting comment=WHATSAPP content=.whatsapp.net \
    dst-address-list="!LOKAL C"
add action=add-dst-to-address-list address-list=sosmed address-list-timeout=\
    01:00:00 chain=prerouting comment=WHATSAPP content=.whatsapp.com \
    dst-address-list="!LOKAL C"
add action=add-dst-to-address-list address-list=sosmed address-list-timeout=\
    01:00:00 chain=prerouting comment=fb content=.facebook.com dst-address-list=\
    "!LOKAL C"
add action=add-dst-to-address-list address-list=sosmed address-list-timeout=\
    01:00:00 chain=prerouting comment=fb content=.facebook.net dst-address-list=\
    "!LOKAL C"
add action=add-dst-to-address-list address-list=sosmed address-list-timeout=\
    01:00:00 chain=prerouting comment=fb content=.fbcdn.net dst-address-list=\
    "!LOKAL C"
add action=add-dst-to-address-list address-list=sosmed address-list-timeout=\
    01:00:00 chain=prerouting comment=twitter content=.twitter.com \
    dst-address-list="!LOKAL C"
add action=add-dst-to-address-list address-list=sosmed address-list-timeout=\
    01:00:00 chain=prerouting comment=twitter content=twitter.com dst-address-list=\
    "!LOKAL C"
add action=add-dst-to-address-list address-list=sosmed address-list-timeout=\
    01:00:00 chain=prerouting comment=twitter content=.twimg.com dst-address-list=\
    "!LOKAL C"
add action=add-dst-to-address-list address-list=sosmed address-list-timeout=\
    01:00:00 chain=prerouting comment=.telegram.org content=.telegram.org \
    dst-address-list="!LOKAL C"
add action=add-dst-to-address-list address-list=sosmed address-list-timeout=\
    01:00:00 chain=prerouting comment=.telegram.org content=telegram.org \
    dst-address-list="!LOKAL C"
add action=add-dst-to-address-list address-list=sosmed address-list-timeout=\
    01:00:00 chain=prerouting comment=tiktokcdn.com content=tiktokcdn.com \
    dst-address-list="!LOKAL C"
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment=PALADINS \
    dst-address-list="!LOKAL C" dst-port=9000-9999 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment=WARFRAME \
    dst-address-list="!LOKAL C" dst-port=6695-6699 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="POINT BLANK - Zepetto" \
    dst-address-list="!LOKAL C" dst-port=39190-39200,49001-49190 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="FIFA ONLINE" \
    dst-address-list="!LOKAL C" dst-port=7770-7790 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment=LOL dst-address-list=\
    "!LOKAL C" dst-port=2080-2099 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment=HON dst-address-list=\
    "!LOKAL C" dst-port=11031 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment=DRAGONNEST \
    dst-address-list="!LOKAL C" dst-port=14300-14440 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="LOST SAGA" \
    dst-address-list="!LOKAL C" dst-port=14000-14050 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="BLACK SQUAD" \
    dst-address-list="!LOKAL C" dst-port=61000,62000 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="ECHO OF SOUL (EOS)" \
    dst-address-list="!LOKAL C" dst-port=7800 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment=CROSSFIRE \
    dst-address-list="!LOKAL C" dst-port=10009 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="IDOL STREET" \
    dst-address-list="!LOKAL C" dst-port=2001-2010 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="RF ONLINE" \
    dst-address-list="!LOKAL C" dst-port=27780 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="ROHAN ONLINE" \
    dst-address-list="!LOKAL C" dst-port=22100 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="PERFECT WORLD" \
    dst-address-list="!LOKAL C" dst-port=29000 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment=AYODANCE \
    dst-address-list="!LOKAL C" dst-port=18900-18910 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="COUNTER-STRIKE ONLINE" \
    dst-address-list="!LOKAL C" dst-port=36567,8001 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment=AYOOKE dst-address-list=\
    "!LOKAL C" dst-port=28001-28010 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="SPECIAL FORCE" \
    dst-address-list="!LOKAL C" dst-port=27920-27940 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment=X-SHOT dst-address-list=\
    "!LOKAL C" dst-port=7320-7350 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="MERCENARY OPS" \
    dst-address-list="!LOKAL C" dst-port=6000-6125 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="PERFECT WORLD" \
    dst-address-list="!LOKAL C" dst-port=29000 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="LINE GET RICH" \
    dst-address-list="!LOKAL C" dst-port=10500-10515 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="COC (CLASH OF CLANS)" \
    dst-address-list="!LOKAL C" dst-port=9330-9340 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="DOMINO QQ" \
...
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="SHINOBI HEROES" \
    dst-address-list="!LOKAL C" dst-port=10005-10020 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="CLASH ROYALE (CRY)" \
    dst-address-list="!LOKAL C" dst-port=9330-9340 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="LAST EMPIRE WAR Z" \
    dst-address-list="!LOKAL C" dst-port=9930-9940 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment=MOSTLY dst-address-list=\
...
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="DANCE UP INDO" \
    dst-address-list="!LOKAL C" dst-port=10000-10010 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="BOOYA CAPSA SUSUN" \
    dst-address-list="!LOKAL C" dst-port=7090-7100 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="BOOYA DOMINO QIUQIU" \
    dst-address-list="!LOKAL C" dst-port=7020-7030 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="Free fire garena" \
    dst-address-list="!LOKAL C" dst-port=39698,39003,39779 protocol=tcp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment=DOTA2 dst-address-list=\
    "!LOKAL C" dst-port=27000-28998 protocol=udp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment=PUBG dst-address-list=\
...
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment=BLACKRETRIBUTION \
    dst-address-list="!LOKAL C" dst-port=7020-7050,8200-8220,9000-9020 \
    protocol=udp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="LEFT4DEAD 2" \
    dst-address-list="!LOKAL C" dst-port=4360-4390 protocol=udp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment=WARFRAME \
    dst-address-list="!LOKAL C" dst-port=4950-4955 protocol=udp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="LAST MAN TANDING" \
...
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment=ROBLOX dst-address-list=\
    "!LOKAL C" dst-port=56849-57729,60275-64632 protocol=udp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="RULES OF SURVIVAL" \
    dst-address-list="!LOKAL C" dst-port=24000-24050 protocol=udp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="CLASH ROYALE (CRY)" \
    dst-address-list="!LOKAL C" dst-port=9330-9340 protocol=udp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="DREAM LEAGUE SOCCER" \
    dst-address-list="!LOKAL C" dst-port=60970-60980 protocol=udp
add action=add-dst-to-address-list address-list="IP GAME ONLINE" \
    address-list-timeout=01:00:00 chain=prerouting comment="RPG TORAM ONLINE" \
